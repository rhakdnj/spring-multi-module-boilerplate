...
import kr.rhakdnj.core.auth.AuthTokenProvider
import kr.rhakdnj.core.auth.filter.TokenAuthenticationFilter
import kr.rhakdnj.core.filter.LoggingFilter
import kr.rhakdnj.core.logging.Logger.Companion.log
import kr.rhakdnj.core.util.writeHttpServletResponse
...
class SecurityConfiguration(
	private val corsProperties: kr.rhakdnj.admin.api.configuration.CorsProperties,
		...
		http.invoke {
			...
			exceptionHandling {
				authenticationEntryPoint =
					kr.rhakdnj.admin.api.configuration
